...
class ContextSerializer(object):
    ...
    def handle_user(self, data):
        ...
        if 'django.contrib.sessions.middleware.SessionMiddleware' in settings.MIDDLEWARE_CLASSES or 'django.contrib.sessions.middleware.SessionMiddleware' in settings.MIDDLEWARE:
